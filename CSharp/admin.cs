...
namespace Addon_API {
    ...
    public struct IAdmin {
        ...
        public delegate int d_is_authorized(ref PlayerInfo player, [In, MarshalAs(UnmanagedType.LPWStr)] string command, [In, Out] ref ArgContainerVars arg, [In, Out] ref CmdFunc func);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int d_is_username_exist([In, MarshalAs(UnmanagedType.LPWStr)] string username);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int d_add([In, MarshalAs(UnmanagedType.LPWStr)] string hashW, [In, MarshalAs(UnmanagedType.LPWStr)] string IP_Addr, [In, MarshalAs(UnmanagedType.LPWStr)] string IP_Port, [In, MarshalAs(UnmanagedType.LPWStr)] string username, [In, MarshalAs(UnmanagedType.LPWStr)] string password, [In] short level, [In, MarshalAs(UnmanagedType.I1)] bool remote, [In, MarshalAs(UnmanagedType.I1)] bool pass_force);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int d_delete([In, MarshalAs(UnmanagedType.LPWStr)] string username);
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
