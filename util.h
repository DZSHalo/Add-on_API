    ...
    CNATIVE dllport bool WINAPIC islettersA(const char* str);
    CNATIVE dllport bool WINAPIC islettersW(const wchar_t* str);

    CNATIVE dllport bool WINAPIC isfloatA(const char* str);
    CNATIVE dllport bool WINAPIC isfloatW(const wchar_t* str);
    CNATIVE dllport bool WINAPIC isdoubleA(const char* str);
    CNATIVE dllport bool WINAPIC isdoubleW(const wchar_t* str);
}
#endif