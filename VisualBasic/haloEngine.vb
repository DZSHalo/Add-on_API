...
Namespace Addon_API
    ...
    Public Structure IHaloEngine
        ...
        Public Delegate Function d_build_packet(<[In], Out> packet_data As Byte(), <[In]> arg1 As UInteger, <[In]> packettype As UInteger, <[In]> arg3 As UInteger, <[In]> ByRef data_pointer As IntPtr, <[In]> arg4 As UInteger,    
            <[In]> arg5 As UInteger, <[In]> arg6 As UInteger) As UInteger
        <UnmanagedFunctionPointer(CallingConvention.Cdecl)>    
        Public Delegate Sub d_add_packet_to_player_queue(<[In]> machine_index As UInteger, <[In], MarshalAs(UnmanagedType.LPArray)> packet As Byte(), <[In]> packetCode As UInteger, <[In]> arg1 As UInteger, <[In]> arg2 As UInteger, <[In]> arg3 As UInteger,    
            <[In]> arg4 As UInteger, <[In]> arg5 As UInteger)
        <UnmanagedFunctionPointer(CallingConvention.Cdecl)>
        Public Delegate Sub d_add_packet_to_global_queue(<[In], MarshalAs(UnmanagedType.LPArray)> packet_data As Byte(), <[In]> packetCode As UInteger, <[In]> arg1 As UInteger, <[In]> arg2 As UInteger, <[In]> arg3 As UInteger,
            <[In]> arg4 As UInteger, <[In]> arg5 As UInteger)
        <UnmanagedFunctionPointer(CallingConvention.Cdecl)>    
