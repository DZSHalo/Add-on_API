...
public:
    ...
    virtual void WINAPIC changeTeam(PlayerInfo& plI, const BYTE new_team, bool forcekill)=0;
    virtual void WINAPIC applyCamo(PlayerInfo& plI, DWORD duration)=0;    //In seconds format.
};
#ifdef EXT_IPLAYER
