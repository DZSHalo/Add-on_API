...
enum e_bitmap_type :unsigned short {
...
enum e_bitmap_format :unsigned short {
...
enum e_bitmap_usage :unsigned short {
...
enum e_sprite_size : unsigned short {
    SPRITE_32x32 = 0,
    SPRITE_64x64,
    SPRITE_128x128,
    SPRITE_256x256,
